    ...
    <div className={styles.container}>
      <div className={styles.mainContainer}>
        <div className={styles.leftSection}>
          ...
          >
            ...
            >
              Discover Your Dream Career with {" "}
              <span className={styles.highlight}>HireHaven</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 50 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Empowering thousands of job seekers to land their ideal jobs every day.
            </motion.p>
            <motion.div
            ...
            >
              <div className={styles.inputContainer}>
                ...
                <input
                  ...
                  value={search}
                  type="text"
                  placeholder="Search jobs Here {Eg: Software Engineer}"
            ...
            >
              <span className={styles.tagsTitle}>Popular Tags:</span>
                {["Software Engineering", "Web Developer", "Machine Learning Engineering"].map((tag) => (
                <motion.span
                  key={tag}
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.bottomFooter}>
          <p>&copy; {new Date().getFullYear()} Hire Haven. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
